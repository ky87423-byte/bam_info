...
<div class="popup_layer report-" style="display:none;">
	<div class="h6wrap">
		<h6><?php echo $nf_shop->kind_of[$page_code];?> 신고하기</h6>
			...
			<tr>
				...
				<td>
					<select name="select" hname="신고사유" needed>
						...
						<?php
						if(is_array($cate_p_array['shop_'.$page_code.'_report_reason'][0])) { foreach($cate_p_array['shop_'.$page_code.'_report_reason'][0] as $k=>$v) {
						?>
