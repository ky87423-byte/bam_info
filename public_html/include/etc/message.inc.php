<?php
$message_action = NFE_URL.'/include/regist.php';
$message_mode = 'message_write';
if(strpos($_SERVER['PHP_SELF'], '/admini/')!==false) {
	$message_action = NFE_URL.'/admini/regist.php';
	$message_mode = 'admin_message_write';
}
?>
<form name="fmessage" action="<?php echo $message_action;?>" method="post" onSubmit="return nf_util.ajax_submit(this)">
<input type="hidden" name="mode" value="<?php echo $message_mode;?>" />
...
<?php
if(strpos($_SERVER['PHP_SELF'], '/member/mail.php')!==false || strpos($_SERVER['PHP_SELF'], '/admini/')!==false) {
?>
