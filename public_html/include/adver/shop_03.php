...
if(strpos($_SERVER['PHP_SELF'], '/include/category_view.php')!==false) $_arr['num'] = $env['service_config_arr']['shop'][$service_k]['sub_height'];
$_arr['tema'] = 'B';
$_arr['anchor'] = '#shop03';
$_arr['var'] = 'page03';
...
<section class="smart">
	<h2><img src="../images/icon/sub_h2_img03.png" alt="아이콘"><?php echo $nf_shop->service_name['shop']['main'][2];?><b>많은 고객님께 인기있는 업체입니다.</b></h2>
	<ul class="list_item smart_m">
		<?php
		switch($total['c']<=0) {
			case true:
		?>
		<li class="no_info">스마트 업체 내역이 없습니다.</li>
		<?php
			break;
