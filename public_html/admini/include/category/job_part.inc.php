<tr class="tac <?php echo $insert_tag ? 'add_form_view' : '';?>" no="<?php echo $row['no'];?>">
	...
	<td>
		...
		<button type="button" class="s_basebtn gray" onclick="nf_util.ajax_post(this, '삭제하시겠습니까?')" no="<?php echo $row['no'];?>" mode="delete_category" url="../regist.php">삭제</button>
	</td>
</tr>