	...
	<section>
		...
		<div class="consadmin conbox">
			<div class="guide">
				...
				<ul>
					<li>- 심사전, 홈페이지에 등록되기 전인 채용공고 리스트입니다.</li>
					<li>- 해당 공고의 서비스/기간등을 수정하시고 싶으실때는 편집에 서비스승인 버튼을 클릭해주시면 됩니다.</li>
					<li>- 등록하기 버튼은 관리자가 직접 해당회원의 새로운 채용공고를 등록하는 기능입니다.</li>
					<li>- 복사하기 버튼은 해당 채용공고를 복사하여 수정후 새로운 채용공고로 등록하는 기능입니다.</li>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<label for=""><input type="checkbox">채용시까지</label>
								</td>
							</tr>
							<tr>
								<th>접수방법</th>
			...
			<h6>심사 채용공고 관리<span>총 <b>0</b>건이 검색되었습니다.</span>
				<p class="h6_right">
				...
				<tbody>
					<tr class="tac">
						...
						<td style="text-align:center">
							...
							<button class="gray common"><i class="axi axi-pencil"></i> 공고등록</button>
