	...
	<section class="employ_modify">
		...
		<div class="conbox">
			...
			<table>
				...
				<tbody>
					<?php
					unset($nf_job->service_name['resume']['sub']['list']);
					if(is_array($nf_job->service_name['resume']['sub'])) { foreach($nf_job->service_name['resume']['sub'] as $k=>$v) {
						$date_val = $re_row['wr_service1_'.$k]>'1970-01-01' ? $re_row['wr_service1_'.$k] : "";
					?>
					<tr>
						<th><?php echo $v;?></th>
						<th class="bl">기간</th>
					...
					$date_val = $re_row['wr_service1_border']>'1970-01-01' ? $re_row['wr_service1_border'] : "";
					?>
					<tr>
						<th class="bl">테두리강조</th>
						<th class="bl">기간</th>
			...
			<table class="MAT5 bt">
				...
				<?php
				$date_val = $re_row['wr_service1_list']>'1970-01-01' ? $re_row['wr_service1_list'] : "";
				?>
				<tbody>
					<tr>
						<th>채용정보 일반리스트</th>
