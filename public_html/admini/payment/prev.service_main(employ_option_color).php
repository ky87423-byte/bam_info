		...
		<div class="consadmin conbox">
			<div class="guide">
				...
				<ul>
					...
					<li>- 채용, 이력서 옵션서비스에서 아이콘은 직접 등록/수정/삭제 가능하며, 형광펜은 색상 설정이 가능합니다.</li>
				</ul>
			</div>
			...
			<h6>채용정보 옵션서비스 > 글자색 > 글자색설정</h6>
			<table>
				<colgroup>
					<col width="10%">
				</colgroup>
				<tr>
					<th rowspan="2">글자색 설정</th>
					<td>
						<ul>
							<li class="MAB5"><input type="text" class="input5" placeholder="0"><button class="gray basebtn MAL5"><img src="../../images/admini/color_choice.png" alt="">색상표</button><button class="gray basebtn MAL5 ">+ 추가</button></li>
							<li class="MAB5"><input type="text" class="input5" placeholder="0"><button class="gray basebtn MAL5"><img src="../../images/admini/color_choice.png" alt="">색상표</button><button class="gray basebtn MAL5">- 제거</button></li>
						</ul>
					</td>
				</tr>
				<tr>
