			...
			<div class="ass_list">
				<table>
					...
					<tr>
						...
						<td>
							<ul>
								<li><a href="./service_main(brand).php">브랜드 채용공고</a></li>	
								<li><a href="./service_main(brand_add).php">건단위 상품</a></li>	
							</ul>
						</td>
					</tr>
				</table>
			...
			<table class="">
				...
				<tr>
					...
					<td>
						...
						<input type="text" class="input5"> 건 / 
						<input type="text" class="input5 MAL10">원,
						할인율 <input type="text" class="input5"> %
