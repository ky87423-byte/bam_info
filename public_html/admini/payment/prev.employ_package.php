	...
	<section>
		...
		<div class="consadmin conbox">
			<div class="guide">
				...
				<ul>
					<li>- 기업회원 채용공고 상품별 패키지 설정을 하는 페이지입니다.</li>
				</ul>
			</div>
			
			<h6>채용공고패키지설정</h6>
			<div class="table_top_btn">
				<button type="button" class="gray"><strong>A</strong> 전체선택</button>
				<button type="button" class="gray"><strong>-</strong> 선택삭제</button>
				<button type="button" class="blue"><strong>+</strong> 패키지 등록</button>
			</div>
			<table class="table4">
				<colgroup>
					<col width="3%">
