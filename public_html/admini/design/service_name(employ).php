...
$service_em_len = count($nf_job->service_name['employ']['sub']);
?>
...
<div class="wrap">
	...
	<section>
		...
		<div class="consadmin conbox">
			...
			<?php
			include NFE_PATH.'/admini/include/service_name_title.inc.php';
			?>
			...
			<table class="table3">
				...
				<tbody>
					...
					<tr>
						<?php if($count===0) {?>
						<td class="tac" rowspan="<?php echo $service_em_len;?>"><img src="../../images/admini/ervice_name(employ).jpg" alt=""></td>
						<?php }?>
						<th class="tac">채용<?php echo substr($nf_util->alphabet, $count, 1);?>영역</th>
						<td class="tac"><em class="service_name_txt"><?php echo $v;?></em> 채용정보</td>
						<td class="tac">
