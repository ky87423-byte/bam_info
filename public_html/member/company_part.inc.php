...
<table class="style1">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<input type="text" name="mb_name" value="<?php echo $nf_util->get_html($my_member['mb_name']);?>" <?php echo $is_auth && $my_member['mb_name'] ? 'readOnly' : '';?> hname="이름" needed>
			</td>
		</tr>
		<tr>
			<th><?php echo $icon_need;?>업체명</th>
			<td><input type="text" name="mb_company_name" hname="업체명" needed class="input10" value="<?php echo $nf_util->get_html($my_member['mb_company_name']);?>" /></td>
		</tr>
		<tr>
			<th>업체소개</th>
			<td><textarea name="mb_company_intro" hname="업체소개" class="input10" style="width:100%;height:100px;"><?php echo stripslashes($my_member['mb_company_intro']);?></textarea></td>
		</tr>
