...
<?php
	...
	//' 회원사 사이트명, URL
    //'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	$SITE_NAME	=	iconv("UTF-8", "CP949", stripslashes($env['wr_site_name']));
	$SITE_URL 	=   $_SERVER['HTTP_HOST'];
	
	//'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	//' KCB로부터 부여받은 회원사코드(아이디) 설정 (12자리)
	//'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	$CP_CD = $env['wr_hphone_id'];
	...
	$RETURN_URL = $http.$_SERVER['HTTP_HOST']."/plugin/auth/kcb/phone/phone_popup3.php";// 인증 완료 후 리턴될 URL (도메인 포함 full path)
	
	//'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	//' 인증요청사유코드 (가이드 문서 참조)
    //'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	$RQST_CAUS_CD = $env['wr_use_adult'] ? '01' : '00';
...
<body>
	<form name="auth_sms_form" method="post">
	<!-- 인증 요청 정보 -->
	<!--// 필수 항목 -->
	...
	<input type="hidden" name="action_sms" value="<?php echo $popupUrl?>">
	<!-- 필수 항목 //-->	
	</form>
<?php
 	if ($RSLT_CD == "B000") {
