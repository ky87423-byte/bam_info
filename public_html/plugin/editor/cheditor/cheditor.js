...
function setConfig() {
    var config = {
        ...
        editorBgColor       : '#fff',
        editorFontColor     : '#000',
        editorFontName      : '"Nanum Gothic","나눔고딕", gulim',
        editorFontSize      : '16px',
        editorHeight        : '300px',
        editorPath          : null,
        editorWidth         : '100%',
        ...
        imgCaptionFigure    : 'border: 0px #ccc solid; background-color: #fff; margin: 0;text-align:left',
        imgCaptionText      : 'margin: 10px 0px 10px 0px;color:#999; text-align: left; line-height: 18px; font-size: 12px; letter-spacing: -0.04em; text-align:justify;',
        imgCaptionWrapper   : '',
        ...
        imgResizeValue      : [120, 240, 320, 660, 880, 1200, -1], // -1 = 사용자 직접 입력
        imgSetAttrAlt       : true,
        ...
        useFullScreen       : false,
        usePageBreak        : false,
		allowedMaxImgSize : editor_max_size
    },
