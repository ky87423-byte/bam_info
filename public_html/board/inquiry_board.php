			...
			<section class="commu board_list">
				<div class="side_con">
					<ul class="fl title_btn">
						<li class="on"><a href="<?php echo NFE_URL;?>/board/inquiry_board.php?cno=<?php echo $_GET['cno'];?>">TOP조회<em> 게시물</em></a></li>
						<li><a href="<?php echo NFE_URL;?>/board/chu_board.php?cno=<?php echo $_GET['cno'];?>">TOP추천<em> 게시물</em></a></li>
				...
				$q = "nf_board_int force index(basic) where code='hit' and `wdate`>='".$date_cnt." 00:00:00'";
