...
<table class="<?php echo $table_cc;?>">
	...
	<tr>
		...
		<th class="m_no">추천수</th>
	</tr>
	<!--
		가능하다면 1~3등 순위 표 영역에는 아래 이미지를 사용해주세요
		1등 : <img style="width:20px" src="../images/1st.png" alt="1등 추천수">
		2등 : <img style="width:20px"  src="../images/2st.png" alt="2등 추천수">
		3등 : <img style="width:20px"  src="../images/3st.png" alt="3등 추천수">
	-->
		<?php
			break;
		}
