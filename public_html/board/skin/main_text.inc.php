<div class="text_board boardlist">
	...
	<ul>
		...
		?>
		<li><a href="<?php echo $b_info['a_href'];?>" class="line1"><?php if($row['wr_category']) {?><em class="col01">[<?php echo $row['wr_category'];?>]</em><?php } echo $b_info['list_subject'];?></a><span class="line1"><?php echo date("y.m.d", strtotime($row['wr_datetime']));?></span></li>
		<?php
		}
		?>
	</ul>
